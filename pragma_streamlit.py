...
def chatbot_answer(question):
    ...
    rulebook = {
        "cu": {
            "judgment": "현재 질문은 Cu 농도 관리 이슈로 보입니다. Cu 농도가 높아지면 에칭 반응 균형이 깨지고 Etch factor 저하 또는 선폭 품질 변동으로 이어질 수 있습니다.",
        ...
        "구리": {
            "judgment": "현재 질문은 구리 농도 상승과 관련된 것으로 보입니다. 구리 농도 축적은 에칭액 반응성을 떨어뜨려 미에칭 또는 선폭 불균일을 유발할 수 있습니다.",
        ...
        "온도": {
            "judgment": "현재 질문은 에칭 온도 조건과 관련된 것으로 보입니다. 온도는 에칭 반응 속도에 직접 영향을 주기 때문에 상승 시 과에칭 가능성이 커질 수 있습니다.",
        ...
        "비중": {
            "judgment": "현재 질문은 에칭액 비중 변화와 관련된 것으로 보입니다. 비중 변화는 약액 농도 변화와 연결되어 에칭 균일성에 영향을 줄 수 있습니다.",
        ...
        "첨가제": {
            "judgment": "현재 질문은 첨가제 농도 관리 이슈로 보입니다. 첨가제 농도 저하는 Etch factor 저하, 미에칭, 선폭 불균일과 연결될 수 있습니다.",
        ...
        "etch factor": {
            "judgment": "현재 질문은 Etch factor 저하와 관련된 것으로 보입니다. Etch factor는 선폭 품질과 직접 연결되므로 우선 점검이 필요합니다.",
        ...
        "선폭": {
            "judgment": "현재 질문은 선폭 변동과 관련된 것으로 보입니다. 선폭 이슈는 과에칭/미에칭, Cu 두께 산포, Etch factor 변화와 함께 판단해야 합니다.",
        ...
        "ph": {
            "judgment": "현재 질문은 현상액 pH 관리 이슈로 보입니다. pH 이탈은 현상 품질과 잔사 발생에 영향을 줄 수 있습니다.",
